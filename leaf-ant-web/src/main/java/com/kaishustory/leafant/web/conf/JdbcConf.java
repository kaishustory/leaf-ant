...
package com.kaishustory.leafant.web.conf;
...
public class JdbcConf {
     ...
     */
    @SneakyThrows
    private Connection getConn(String host, String port, String database, String user, String password){
        ...
        if(connPool.containsKey(dataSourceKey)){
            ...
            dataSource.setJdbcUrl(String.format("jdbc:mysql://%s:%s/%s?characterEncoding=UTF-8", host, port, database));
